...
def handle_message(message):
    try:
        ...
        if user_input == "/start":
            bot.send_message(message.chat.id, 'هلو يابه كل الهلا')
        else:
            ...
            if data.get('Response') == 'True':
                ...
                bot.send_message(message.chat.id, "الفلم غير موجود")

    except Exception as e:
        bot.send_message(message.chat.id, "حدثت مشكلة ما يرجى المحاولة لاحقاً")
